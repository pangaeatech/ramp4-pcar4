...
import { ref as f, computed as P, markRaw as X, defineComponent as O, inject as ge, reactive as we, watch as It, onBeforeUnmount as pt, resolveDirective as k, withDirectives as M, createElementBlock as A, openBlock as v, withKeys as ds, withModifiers as Xt, onMounted as Ke, normalizeStyle as Mi, normalizeClass as ie, createVNode as ne, Transition as Pi, withCtx as se, createBlock as W, resolveDynamicComponent as ps, mergeProps as hs, useCssVars as fs, TransitionGroup as Ni, Fragment as Ye, renderList as ht, unref as I, nextTick as Ot, renderSlot as Me, createElementVNode as m, vShow as ms, resolveComponent as Z, createTextVNode as nt, toDisplayString as U, createCommentVNode as V, onUpdated as ys, Teleport as gs, getCurrentInstance as vs, useTemplateRef as mi, createApp as Fi, toRaw as Ie, h as bs, render as Bt, defineAsyncComponent as ws } from "vue";
...
class pe extends Ze {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = pe.arrayDeepCopy(t) : t instanceof pe ? this.rawArray = t.toArray() : this.rawArray = pe.parsePointSet(t);
  }
...
class ve extends Ze {
  ...
  constructor(e, t, i, r) {
    if (super(e, t.sr || i), r)
      ...
      this.rawArray = t.map((a) => pe.parsePointSet(a));
    } else
...
class Oe extends Ze {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof oe)
      return [e.toArray()];
    if (e instanceof ve || e instanceof pe)
...
class Bs {
  ...
  async projectExtent(e, t) {
    ...
    const o = new oe("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), d = Math.min.apply(null, c), p = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
    return G.fromParams(t.id + "_projected", d, g, p, h, l.sr);
  }
}
class zs {
  // useful functions
...
const $t = B("appbar", () => {
  ...
  const s = f([]), e = f([]), t = f([]);
  function i(d) {
    return zt(s.value, (p) => p?.uid === d);
  }
  function r(d) {
    return zt(s.value, (p) => p?.id === d);
  }
  function a(d) {
    return zt(
      s.value,
      (p) => p !== void 0 && (p.id === d || p.uid === d)
    );
  }
  function o(d) {
    e.value = [...e.value, d];
  }
  function l(d, p = void 0) {
    s.value = [...s.value, d], d.mapLayer && ((p === void 0 || p < 0) && (console.error("Map layer added to store with invalid index!"), p = t.value.length), t.value.splice(p, 0, d.id), t.value = [...t.value]);
  }
  function n(d, p) {
    if (!d.mapLayer) {
    ...
    p >= t.value.length && (p = t.value.length - 1);
    const g = t.value.findIndex((h) => h === d.id);
    g !== -1 && g !== p && (t.value.splice(g, 1), t.value.splice(p, 0, d.id), t.value = [...t.value]);
  }
  function c(d) {
    const p = s.value.filter((g) => g.id !== d.id || g.uid !== d.uid);
    if (s.value = p, d.mapLayer) {
      const g = t.value.filter((h) => h !== d.id);
      t.value = g;
    }
  }
  function u(d) {
    const p = e.value.filter((g) => g.id !== d);
    e.value = p;
  }
  return {
    /**
  ...
  function o(c) {
    ...
    if (s.value = u, Array.isArray(s.value.layers)) {
      const d = _e();
      d.layerConfigs = [...d.layerConfigs, s.value.layers];
    }
  }
  function l(c, u) {
  ...
  function n(c, u) {
    const d = c.configs, p = Object.keys(d);
    if (p.length) {
      const g = p[0];
      u.forEach((h) => {
        const y = p.includes(h) ? h : g;
        i.value[h] = d[y], r.value[h] = y;
      });
    } else
  ...
  function n(u) {
    const d = s.value.findIndex((p) => p.uid === u.uid);
    d !== -1 && s.value.splice(d, 1);
  }
  function c(u) {
  ...
  function i(o) {
    if (s.value = { ...s.value, [o.id]: X(o) }, o.id in e.value)
      e.value[o.id].resolveMe(X(o));
    else {
      const l = new H();
      l.resolveMe(X(o)), e.value = {
        ...e.value,
        [o.id]: l
      };
    }
...
const Ct = B("maptip", () => {
  ...
  setup(s) {
    ...
    o.push(
      It(i, () => {
        if (i.value) {
          const c = t.geo.map.getPixelWidth() / 2, u = 0, d = t.geo.map.mapPointToScreenPoint(i.value), p = d.screenX - c, g = u - d.screenY;
          r.value.setProps({
            // Offset more for touch devices so tooltip is visible above finger
            offset: l.value ? [p, g + 25] : [p, g]
    ...
    return (c, u) => {
      ...
      return M((v(), A("div", {
        ...
        onMousedown: n,
        onTouchstart: u[0] || (u[0] = (p) => l.value = !0),
        onTouchend: u[1] || (u[1] = (p) => l.value = !1),
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const r = i.target.dataset.breakpoints, a = r ? JSON.parse(r) : e ?? Xs;
...
const er = ["data-cy"], Ji = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return v(), A("div", {
        ...
        ne(Pi, {
          ...
          default: se(() => [
            M((v(), W(ps(s.panel.route.screen), hs({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const s = f(void 0), e = f(void 0), t = f(0), i = f(0), r = f(!1), a = f(!0), o = f({}), l = f({}), n = f([]), c = f([]), u = f([]), d = f(1), p = P(() => i.value);
  function g(S) {
  ...
  setup(s) {
    ...
    Ke(() => {
      new ResizeObserver((d) => {
        ...
        a.value !== p && (e.mobileView = p, t.event.emit(E.RAMP_MOBILEVIEW_CHANGE, p)), e.setStackWidth(d[0].contentRect.width);
      }).observe(i.value?.$el);
    });
    const o = (u) => (
      ...
      const [p, g] = [u.children[0].getBoundingClientRect(), u.parentElement.getBoundingClientRect()];
      u.style.width = `${p.width}px`, u.style.height = `${p.height}px`, u.style.left = `${p.left - g.left}px`, u.style.position = "absolute", c(u, d, [
        [0, -6],
        [1, 0]
      ]);
    }, c = (u, d, p) => {
    ...
    return (u, d) => (v(), W(Ni, {
      ...
      default: se(() => [
        (v(!0), A(Ye, null, ht(o(I(t).screenSize), (p) => (v(), W(Ji, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  setup(s) {
    ...
    return Ke(() => {
      window.addEventListener(
        "click",
        (d) => {
          (!r.value || !r.value.contains(d.target)) && (e.value = !1);
        },
        { capture: !0 }
        ...
        const d = {
          ...
          fn({ state: p }) {
            const { bottom: g } = Ns(p);
            g > 0 ? (p.styles.popper.overflowY = g > 100 ? "auto" : void 0, p.styles.popper.overflowX = "hidden", p.styles.popper.height = `${p.rects.popper.height - g - 8}px`) : p.styles.popper.height = "auto";
          }
        };
      ...
      i.forEach((d) => d()), window.removeEventListener(
        "click",
        (d) => {
          (!r.value || !r.value.contains(d.target)) && (e.value = !1);
        },
      ...
      return v(), A("div", {
        ...
        M(m("div", {
          onClick: p[0] || (p[0] = (h) => t.value.update()),
...
const cr = ["content"], ur = { class: "flex items-center text-left" }, dr = { class: "select-text cursor-text" }, pr = ["content"], hr = {
  key: 0,
  class: "text-left"
}, fr = /* @__PURE__ */ O({
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return M((v(), A("li", {
        ...
        onClick: c[1] || (c[1] = (d) => r.value = !r.value)
      }, [
        m("div", ur, [
          m("span", null, [
          ...
          M((v(), A("button", {
            type: "button",
            onClick: c[0] || (c[0] = Xt((d) => o(s.notification), ["stop"])),
        ...
        s.notification.messageList && r.value ? (v(), A("div", hr, [
          (v(!0), A(Ye, null, ht(s.notification.messageList, (d, p) => (v(), A("p", {
            key: s.notification.id + d + p
          }, U(d), 1))), 128))
        ])) : V("", !0)
      ], 10, cr)), [
  ...
  setup(s) {
    ...
    return (l, n) => {
      const c = k("focus-item"), u = k("focus-list"), d = k("tippy");
      return v(), A("div", null, [
        o.value.length > 0 ? M((v(), A("ul", {
          ...
          (v(!0), A(Ye, null, ht(o.value, (p, g) => (v(), A(Ye, {
            key: p.message + g
          }, [
            g > 0 ? (v(), A("div", yr)) : V("", !0),
            M(ne(fr, {
          ...
          [u],
          [d, { trigger: "manual", placement: "top-start", touch: !1 }]
        ]) : (v(), A("div", gr, [
  ...
  setup(s) {
    ...
    return (l, n) => {
      const c = Z("close"), u = Z("dropdown-menu"), d = k("tippy"), p = k("focus-item");
      return M((v(), W(u, {
  ...
  __name: "map-caption",
  setup(s) {
    const e = Ue(), t = de(), { t: i } = Y(), r = ge("iApi"), a = P(() => e.scale), o = P(() => e.attribution), l = P(() => e.coords), n = P(() => e.langtoggle), c = P(() => t.config.map), u = f([]), d = we([]);
    d.push(
      It(c, (w) => {
    ...
    const p = () => o.value?.logo?.link && o.value?.logo?.value && !o.value?.logo?.disabled, g = (w) => {
      ...
      return i.value ? (v(), A("div", {
        ...
        m("div", {
          ...
          m("div", sa, [
            ...
            ne(d, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (p) => i.value = !1)
            })
          ]),
          (v(!0), A(Ye, null, ht(r.value, (p) => (v(), A("p", {
            class: "whitespace-pre-line pb-10",
            key: p
          }, U(I(t)(`keyboardInstructions.${p}`)), 1))), 128)),
          m("button", {
            type: "button",
            class: "mt-auto self-end mr-10 mb-10 px-20 py-10",
            onClick: u[1] || (u[1] = (p) => i.value = !1),
            ref_key: "lastEl",
            ref: l
  ...
  setup(s) {
    ...
    return (c, u) => (v(), A("div", oa, [
      ...
      I(t).started ? (v(), W(Qs, { key: 0 })) : (v(), A("div", ca, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), A(Ye, null, ht(n(), (d) => (v(), W(gs, {
...
}), da = /* @__PURE__ */ Ne(ua, [["__scopeId", "data-v-3d441124"]]), pa = O({
  name: "App",
  components: { Shell: da },
  setup() {
    const s = vs();
...
const ya = /* @__PURE__ */ Ne(pa, [["render", ma]]), Se = "focus-list", je = "focus-item", ga = "focus-icon", va = "focus-container", ut = `[${Se}],[${va}]`, wt = "truncate-text", At = "show-truncate", ot = "focused", Kt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${ga}],[tabIndex]`, ba = {
  mounted(s, e) {
...
class wa {
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === At && this.highlightedItem.querySelector(`[${wt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Qi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const si = "focus-container", Xi = "focus-list", xa = "focus-icon", qt = `[${Xi}],[${si}]`, Ai = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Xi}],[${si}],[${xa}],[tabIndex]`;
let jt = [];
const Sa = {
  mounted(s) {
...
const Ca = ["content"], Oa = {
  ...
  setup(s, { expose: e }) {
    ...
    e({ el: o });
    const c = s, u = P(() => a.fixture.get("appbar") ? r.temporary : []), d = P(() => i.mobileView), p = P(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !d.value && !c.panel.teleport, y = (b) => {
    ...
    return Ke(() => {
      ...
      const T = Z("back"), N = Z("panel-options-menu"), F = Z("left"), te = Z("right"), Xe = Z("pin"), Nt = Z("expand"), Ft = Z("minimize"), Dt = Z("close"), Gt = k("truncate"), Ut = k("focus-item"), S = k("tippy");
      return M((v(), A("div", {
...
const ri = async (s) => {
  ...
  if (await Mo(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await oi(s), i = e.sortOrder.indexOf("ADDR"), r = i >= 0 ? i : e.sortOrder.length, a = t.filter((o) => o.type?.includes("Street")).map((o) => {
      const [l, n, c] = o.title.split(", "), u = o.geometry.coordinates, d = u[1], p = u[0];
      return {
        name: l,
        flav: "add",
        bbox: Mt(p, d, 2e-3),
...
class Ti {
  ...
  constructor(e, t) {
    ...
    const u = t?.settings;
    let d, p, g, h, y;
    u ? (d = u.categories ? u.categories : [], p = u.sortOrder ? u.sortOrder : [], g = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, y = !!u.officialOnly) : (d = [], p = [], g = [], h = 100, y = !1), this.config = {
      language: e,
      geoNameUrl: r,
      geoLocateUrl: i,
      fsaUrl: n,
...
const qo = B("legend", () => {
  ...
  function o(n) {
    const c = (u) => (u = u.filter((d) => (d === n && !d.children.length && d.onRemoved(), d !== n)), u.forEach((d) => {
      d.children = c(d.children);
    }), u = u.filter(
      (d) => !(d instanceof Ri && !d.children.length && d.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
...
class Zo {
   ...
   */
  initialize(e, t, i) {
    const r = de(this.$vApp.$pinia), a = Je(this.$vApp.$pinia), o = Ct(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      }, p = c.system?.zoomIcon || "globe", g = d[p] || p;
   ...
   */
  reloadWorker(e, t) {
    const i = rt(this.$vApp.$pinia), r = Le(this.$vApp.$pinia), a = de(this.$vApp.$pinia), o = ye(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Yt(this.$vApp.$pinia), c = !!e;
    c ? Object.keys(o.items).forEach((p) => {
      this.fixture.exists(p) && this.fixture.remove(p);
    }) : this.fixture.flush(), Object.keys(n.grids).forEach((d) => {
      n.removeGrid(d);
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = de(this.$vApp.$pinia), i = Le(this.$vApp.$pinia), r = t.registeredLangs;
...
function Qo(s, e) {
  ...
  r.directive("focus-container", Sa), r.directive("focus-list", ba), r.directive("focus-item", Aa), r.directive("truncate", La), r.component("panel-screen", Da), r.component("pin", Ba), r.component("close", ja), r.component("back", Ya), r.component("expand", Xa), r.component("panel-options-menu", uo), r.component("dropdown-menu", ii), r.component("minimize", io), r.component("right", ao), r.component("left", lo), r.component("fullscreen-nav-button", fo), r.component("geolocator-nav-button", mo), r.component("home-nav-button", yo), r.component("mapnav-button", bo), r.component("appbar-button", xo), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || He.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class Xo extends J {
  ...
  async createMap(e, t) {
    ...
    const l = {};
    this.esriMap = X(await C.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
...
class tn extends J {
  ...
  updateAttribution(e) {
    ...
    if (e ? (e.logo ? e.logo.disabled ? r.logo.disabled = !0 : (r.logo.altText = e.logo.altText || i.altText, r.logo.link = e.logo.link || i.link, r.logo.value = e.logo.value || i.value) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value), e.text ? e.text.disabled ? r.text.disabled = !0 : r.text.value = e.text.value || t.value : r.text.value = t.value, Ue(this.$vApp.$pinia).setAttribution(r)) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value, r.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        const c = n.baseLayers.map((u) => new Promise((d) => {
          let p = 0;
          const g = o / l, h = setInterval(function() {
            u.loaded && !u.loadError ? (clearInterval(h), d(u)) : p > g && (clearInterval(h), d(null)), p++;
          }, l);
        })).toArray();
        Promise.all(c).then((u) => {
          a = u.filter((p) => p?.copyright).map((p) => p.copyright).join(" | "), r.text.value = a || r.text.value || t.value, Ue(this.$vApp.$pinia).setAttribution(r);
        });
      }
    }
  }
  ...
  scaleHelper() {
    ...
    for (let n = 0; n < 2; n++) {
      ...
      if (i.push({
        ...
        const u = t * e / (c ? a : 1e3), d = Math.round(u).toString().length, p = Math.pow(10, d - 1);
        i[n].distance = Math.ceil(u / p) * p, i[n].pixels = i[n].distance * (c ? a : 1e3) / t;
      } else
...
class sn extends Xo {
  ...
  async setBasemap(e) {
    ...
    const t = de(this.$vApp.$pinia), i = await this.findBasemap(e), a = t.activeBasemapConfig.tileSchemaId !== i.tileSchemaId;
    if (a) {
    ...
    return new Promise((i, r) => {
      if (this.esriMap || (this.noMapErr(), r()), e.initiationState !== D.INITIATING && e.initiationState !== D.INITIATED && e.layerState !== q.ERROR && e.initiate(), e.mapLayer && t === void 0) {
        ...
        if (e.isCosmetic)
          ...
          let d = !0;
          for (let p = c.length - 1; p >= 0 && d; p--) {
            const g = u.find((h) => h.id === c[p]);
            g && !g.isCosmetic && (t = p + 1, d = !1);
          }
          d && (t = 0);
        }
      }
  ...
  reorder(e, t, i = !1) {
    ...
    if (_e(this.$vApp.$pinia).reorderLayer(e, t), e.esriLayer && this.esriMap.layers.indexOf(e.esriLayer) > -1) {
      ...
      if (t > 0) {
        ...
        for (let c = t - 1; c > -1; c--) {
          const u = a[c], d = r.find((p) => p.id === u);
          if (d && d.esriLayer) {
            const p = this.esriMap.layers.indexOf(d.esriLayer);
            if (p > -1) {
              const g = t < o ? 1 : 0;
              n = p + g;
              break;
            }
          } else d || console.error("Layer reorder had critical error");
        }
      }
  ...
  async symbolIdentify(e, t) {
    ...
    const r = (await this.esriView.hitTest({
      ...
      if (o.graphic.isAggregate === !0) {
        ...
        return c.aggregateIds = [o.graphic.getObjectId()], (await n.queryFeatures(c)).features.map((d) => ({
          layerId: l.id,
          layerIdx: 0,
          oid: d.getObjectId()
        }));
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((u) => u.identifyMode === Q.HYBRID || u.identifyMode === Q.SYMBOLIC) && (a = this.symbolIdentify(i.screenX, i.screenY));
    const o = {
      geometry: i.mapPoint,
      hitTest: a
...
class fn extends J {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((y) => y.trim && g.includes(y.name)).map((y) => y.name) : []).forEach((y) => {
      for (let w = 0; w < p.length; w++) {
        const b = p[w].attributes;
        typeof b[y] == "string" && (b[y] = b[y].trim());
      }
    }), o.source = p, o.spatialReference = d, o.id = a, o;
  }
  ...
  fgbToGeoJson(e, t) {
    return import("flatgeobuf").then(({ geojson: r }) => new Promise((a) => {
      let o = !1, l = null;
      const n = r.deserialize(new Uint8Array(e), void 0, (d) => {
        l = d.crs, o = !0;
      });
      let c = 0;
      const u = setInterval(() => {
        if (n && o) {
          clearInterval(u);
          let d;
          l && (l.code && l.code !== 4326 && l.org === "EPSG" ? d = new _(l.code) : l.wkt ? d = new _(l.wkt) : console.error("Encountered FlatGeobuf with non-EPSG org: ", l)), d && (n.crs = d.toGeoJSON()), a(n);
        } else
...
class yn extends J {
  ...
  async loadWfsData(e, t = -1, i = 0, r = 1e3, a = {
    ...
    const c = new Rt(e).updateQuery(l), [u, d] = await Ae(bt.get(c));
    if (!d)
      return console.error(`WFS data failed to load for ${e}`, u), Promise.reject(u);
    const p = d.data;
    if (t === -1)
      return t = d.data.numberMatched, this.loadWfsData(e, t, i, r, a, o);
    if (a.features = a.features.concat(p.features), p.features.length < t - i) {
      const g = Math.min(r, t - i - p.features.length);
  ...
  parseCapabilities(e) {
    const t = () => {
      ...
      return l ? (Array.isArray(l) || (l = [l]), l.map((n) => {
        ...
        let d = n.Style;
        const p = [], g = {};
        return d && (Array.isArray(d) || (d = [d]), d.forEach((h) => {
          const y = h.Name;
          if (p.push(y), h.LegendURL) {
    ...
    return import("fast-xml-parser").then(({ XMLParser: o }) => i.then((l) => {
      ...
      const d = u.WMS_Capabilities.Capability;
      return {
        layers: r(d),
        queryTypes: a(d.Request.GetFeatureInfo)
      };
    }));
  }
}
...
class gn extends J {
  ...
  async loadLayerMetadata(e) {
    ...
    if (a.name = r.name || "", a.currentVersion = r.currentVersion || -1, a.minScale = r.effectiveMinScale || r.minScale || 0, a.maxScale = r.effectiveMaxScale || r.maxScale || 0, a.extent = r.extent ? G.fromArcServer(r.extent, "layer_extent") : void 0, a.defaultVisibility = r.defaultVisibility ?? !0, a.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
      if (a.dataFormat = ee.ESRI_FEATURE, a.displayField = r.displayField || "", a.typeIdField = r.drawingInfo?.renderer?.field1 || r.typeIdField || "", Array.isArray(r.fields)) {
...
class ss extends li {
   ...
   */
  async legendInitializer(e, t = "") {
    this.supportsFeatures ? this.legendField = (e?.legendField || "").trim() || t || this.oidField : console.error("Attempted to init a legend field on an unsupported layer.");
  }
}
class qe extends ss {
  // common layer properties
...
class ci extends qe {
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ns(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === ee.ESRI_FEATURE) {
        this.supportsFeatures = !0, this.canModifyLayer = this.layerType === x.SUBLAYER ? i.canModifyLayer : !0, this.fields = i.fields, this.nameField = i.displayField, this.legendField = i.typeIdField || "", this.oidField = i.objectIdField, this.sourceSR = i.sourceSR, this.drawOrder.forEach((l) => {
          l.field && this.fields.findIndex((n) => n.name === l.field) === -1 && console.error(`Draw order for layer ${this.id} references invalid field ${l.field}`);
        });
        const r = e && e.customRenderer && e.customRenderer.type ? e.customRenderer : i.renderer, a = await this.updateRenderer(r, this.origRampConfig);
        this.renderer = this.$iApi.geo.symbology.makeRenderer(a, this.fields), this.legend = this.$iApi.geo.symbology.rendererToLegend(this.renderer);
        const o = {
        ...
        this.attribs.attLoader = new os(this.$iApi, o);
      } else
   ...
   */
  async updateRenderer(e, t) {
    const i = t.legendField, r = e.type === "unique-value" ? e.field : null;
    if (i && r && i !== r) {
      const a = await C.Query();
      a.where = "1=1", a.outFields = [i, r], a.returnGeometry = !1, a.returnDistinctValues = !0;
      const o = await this.esriLayer.queryFeatures(a), l = {};
      o.features.forEach((n) => {
        const c = n.attributes[r], u = n.attributes[i];
        c != null && u != null && (l[c] = u);
      }), e.uniqueValueInfos?.forEach((n) => {
        n.label = l[n.value] || n.label;
      });
    }
    return e;
  }
  ...
  async getGraphic(e, t) {
    ...
    if (t.getAttribs || t.getStyle) {
      ...
      if (u)
        ...
        const d = await this.attribs.attLoader.getAttribs();
        i = d.features[d.oidIndex[e]];
      } else
        o = !0;
    }
    if (t.getGeom) {
      ...
      if (u)
        ...
        d.objectIds = [e], d.returnGeometry = !0;
        const p = await this.esriView.queryFeatures(d);
        if (p.features.length) {
          const g = p.features[0], h = this.$iApi.geo.geom.geomEsriToRamp(g.geometry);
    ...
    if (o || l) {
      ...
      const d = await this.$iApi.geo.attributes.loadSingleFeature(u);
      l && (this.attribs.quickCache.setGeom(e, d.geometry, n), r = d.geometry), (o || typeof this.attribs.quickCache.getAttribs(e) > "u") && (this.attribs.quickCache.setAttribs(e, d.attributes), o && (i = d.attributes));
    }
...
class bn extends vn {
  ...
  async onInitiate() {
    this.esriLayer = X(await C.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Qe extends ci {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = he.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async reload() {
  ...
  async onInitiate() {
    ...
    this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = X(await C.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === Q.HYBRID || this.identifyMode === Q.SYMBOLIC) && (r = a.then(async () => {
...
class _n extends ci {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = he.FEATURE, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async onInitiate() {
    X(this.esriLayer = await C.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = async () => {
      ...
      if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
        ...
        n = {};
      await this.loadLayerMetadata(n), e > this.lastCancel && (this.layerTree.name = this.name, this.visibility = this.origRampConfig?.state?.visibility ?? this._serverVisibility ?? !0, this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.attribs.attLoader.updateFieldList(this.fieldList), this.attribs.attLoader.updateFieldsToTrim(this.getFieldsToTrim()), await this.nameInitializer(this.origRampConfig, this.nameField), await this.tooltipInitializer(this.origRampConfig), await this.legendInitializer(this.origRampConfig, this.legendField));
...
class Tn extends qe {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = x.MAPIMAGE, this.layerFormat = he.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = X(await C.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const p = (d ? d.name : "") || n.title || "", g = new Lt(u, "", p, !1);
        ...
        this._sublayers[u] || (this._sublayers[u] = new Ln(
          {
            ...
            extent: d?.extent,
            controls: d?.controls,
            disabledControls: d?.disabledControls,
            initialFilteredQuery: d?.initialFilteredQuery,
            permanentFilteredQuery: d?.permanentFilteredQuery,
            labels: d?.labels
          },
          this.$iApi,
          this
        ));
        const p = this._sublayers[u];
        if (p.isRemoved)
          return;
        if (p.name = d?.name || n.title || "", a.push(p), !c.children.map((g) => g.layerIdx).includes(u)) {
          const g = new Lt(u, p.uid, p.name, !1);
          c.children.push(g);
        }
        p.esriWatches.push(
          be(
    ...
    const l = a.map(async (n) => {
      ...
      if (n.esriSubLayer && u?.customRenderer?.type) {
        ...
        n.esriSubLayer.renderer = g, d.customRenderer = g;
      }
      if (await n.loadLayerMetadata(d), t < this.lastCancel)
        return;
      const p = r[n.layerIdx];
      if (p ? (n.visibility = n.isRemoved ? !1 : p.state?.visibility ?? (this.origState.visibility ? n._serverVisibility ?? this.origState.visibility : this.origState.visibility ?? n._serverVisibility) ?? !0, n.opacity = p.state?.opacity ?? this.origState.opacity ?? 1, this.$iApi.geo.attributes.applyFieldMetadata(n, p.fieldMetadata), n.canModifyLayer || this.$iApi.notify.show(
        me.WARNING,
        this.$iApi.$i18n.t("layer.filtersdisabled", {
          name: n.name || n.id
        })
      )) : this.$iApi.geo.attributes.applyFieldMetadata(n), n.supportsFeatures) {
        n.updateFieldList(), n.updateFieldsToTrim(), await n.nameInitializer(p, n.nameField), await n.legendInitializer(p, n.legendField);
...
class Rn extends qe {
  ...
  async onInitiate() {
    this.esriLayer = X(await C.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class $n extends qe {
  ...
  async onInitiate() {
    this.esriLayer = X(await C.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Cn extends qe {
  ...
  async onInitiate() {
    this.esriLayer = X(await C.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class On extends qe {
  ...
  async onInitiate() {
    this.esriLayer = X(await C.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class kn extends qe {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = he.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = ee.OGC_RASTER, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = X(await C.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  getFeatureInfo(e, t, i) {
    ...
    let o, l;
    const n = r.getExtent(), c = a.spatialReferences, u = e.join(","), d = r.esriView.toScreen(t.toESRI()), p = Math.floor(d.x), g = Math.floor(d.y), y = {
    ...
    }, this.$iApi.geo.layer.ogc.reversedAxisWKIDs().indexOf(o) > -1 && (l.BBOX = `${n.ymin},${n.xmin},${n.ymax},${n.xmax}`)) : l = { SRS: "EPSG:" + o, X: p, Y: g }, Object.prototype.hasOwnProperty.call(l, "BBOX") || (l.BBOX = `${n.xmin},${n.ymin},${n.xmax},${n.ymax}`);
    const b = {
      SERVICE: "WMS",
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((c, u) => {
        let d = "", p = c;
        c.indexOf(" ") > -1 && (d = c, p = c.trim().replace(r, "-"), e.fields[u] = p);
    ...
    if (e.uniqueValueInfos.forEach((o) => {
      ...
      if (l.label = o.label || "", l.symbol = o.symbol, !this.falseRenderer) {
        const n = l.matchValue.split(this.delim), c = this.keyFields.map(
          (u, d) => n[d] === "<Null>" ? `${u} IS NULL` : `${u} = ${a[d]}${r(n[d])}${a[d]}`
        ).join(" AND ");
...
class qn extends J {
  ...
  async symbolToSvg(e) {
    ...
    try {
      return await Promise.resolve(d[e.type]()), document.body.removeChild(r), a.svg();
    } catch (h) {
...
const Hn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-WhuB8aWm.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Di7W4cVw.js"), "../fixtures/basemap/index.ts": () => import("./index-vOxXoK8Y.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CcEs0Tc9.js"), "../fixtures/details/index.ts": () => import("./index-C7ZyaGGm.js"), "../fixtures/draw/index.ts": () => import("./index-CqQfJ5BN.js"), "../fixtures/export-footnote/index.ts": () => import("./index-9qCAH4nS.js"), "../fixtures/export-legend/index.ts": () => import("./index-nu5WRT5S.js"), "../fixtures/export-map/index.ts": () => import("./index-G6hPayWI.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-CekUgq89.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-NhhaiXbv.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-C82W-j_R.js"), "../fixtures/export-title/index.ts": () => import("./index-CvA-vd5n.js"), "../fixtures/export/index.ts": () => import("./index-mAQ-qjTV.js"), "../fixtures/extentguard/index.ts": () => import("./index--zC4sd6h.js"), "../fixtures/gazebo/index.ts": () => import("./index-B5wM82pR.js"), "../fixtures/geosearch/index.ts": () => import("./index-Dmrd00GG.js"), "../fixtures/grid/index.ts": () => import("./index-Drfe6xRx.js"), "../fixtures/help/index.ts": () => import("./index-CoXnJU2F.js"), "../fixtures/hilight/index.ts": () => import("./index-BVDFmWsC.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CRh9FSde.js"), "../fixtures/legend/index.ts": () => import("./index-Cmhw18jP.js"), "../fixtures/mapnav/index.ts": () => import("./index-CXWBrRfU.js"), "../fixtures/metadata/index.ts": () => import("./index-C67i57KD.js"), "../fixtures/northarrow/index.ts": () => import("./index-AF-57u5z.js"), "../fixtures/overviewmap/index.ts": () => import("./index-Bpi67HWT.js"), "../fixtures/panguard/index.ts": () => import("./index-Bj7W5IBO.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DTHVueuG.js"), "../fixtures/settings/index.ts": () => import("./index-DESwkPJR.js"), "../fixtures/snowman/index.ts": () => import("./index-CJ6UXjRf.js"), "../fixtures/swipe/index.ts": () => import("./index-DCR2EgbK.js"), "../fixtures/wizard/index.ts": () => import("./index-DeEu1V_o.js") });
class Yn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = pi.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
...
const Xn = /* @__PURE__ */ Ne(Zn, [["render", Qn], ["__scopeId", "data-v-a3c61802"]]), el = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-ON_3DZIy.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DxALFEEf.js"), "../fixtures/export/screen.vue": () => import("./screen-BOrfiuXU.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-Crx3zM5I.js"), "../fixtures/grid/screen.vue": () => import("./screen-DF42JyMn.js"), "../fixtures/help/screen.vue": () => import("./screen-BnatMt16.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-xZ6iP4oT.js"), "../fixtures/legend/screen.vue": () => import("./screen-BWzbQLXF.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DdFAp-e-.js"), "../fixtures/settings/screen.vue": () => import("./screen-2EsO6VpQ.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CP9cIhm-.js") });
class St extends J {
  /**
   * ID of this panel.
   *
...
var at = { major: "4", minor: "14", patch: "0-beta", timestamp: "Fri Oct 24 09:50:33 2025 -0500", hash: "111d8c30acdc52c626cc1d3ada433f05131908cc" };
console.info(
