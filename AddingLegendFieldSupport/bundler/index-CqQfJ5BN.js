...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-DC1g0E4v.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-eTE6XS8x.js"), "./icons/edit-icon.vue": () => import("./edit-icon-D0SGNA8_.js"), "./icons/point-icon.vue": () => import("./point-icon-zQIGHpd8.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-638g59Vy.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-rf03P6HS.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-OimbmzRe.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
