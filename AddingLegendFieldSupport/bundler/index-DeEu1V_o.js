...
import "tiny-emitter";
import { F as f, k as y, L as a, U as m, I as g } from "./main-DC1g0E4v.js";
  ...
  async getFeatureInfo(e) {
    ...
    return {
      config: {
        ...
        legendField: r.data.drawingInfo?.renderer?.field1 || r.data.typeIdField,
        state: { opacity: 1, visibility: !0 }
      },
    ...
    this.$iApi.panel.register(
      {
        wizard: {
          screens: {
            "wizard-screen": () => u(import("./screen-CP9cIhm-.js"))
          },
          button: {
