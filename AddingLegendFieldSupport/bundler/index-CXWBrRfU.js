...
import { _ as H, d as L, F as K, G as X } from "./main-DC1g0E4v.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-zQIGHpd8.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-rf03P6HS.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-638g59Vy.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-eTE6XS8x.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-OimbmzRe.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D0SGNA8_.js")))
      }), s;
    }), n = (s) => {
