...
import { ref as f, computed as D, markRaw as ne, defineComponent as N, inject as Ie, reactive as Se, watch as Ct, onBeforeUnmount as bt, resolveDirective as G, withDirectives as U, createElementBlock as A, openBlock as b, withKeys as ms, withModifiers as ei, onMounted as rt, normalizeStyle as Pi, normalizeClass as ce, createVNode as fe, Transition as Ni, withCtx as ue, createBlock as te, resolveDynamicComponent as ys, mergeProps as gs, useCssVars as vs, TransitionGroup as Fi, Fragment as it, renderList as wt, unref as I, nextTick as Dt, renderSlot as Be, createElementVNode as m, vShow as bs, resolveComponent as oe, createTextVNode as ft, toDisplayString as B, createCommentVNode as z, onUpdated as ws, Teleport as As, getCurrentInstance as Es, useTemplateRef as yi, createApp as Di, toRaw as ke, h as xs, render as zt, defineAsyncComponent as Ss } from "vue";
...
import { debounce as kt, throttle as ut } from "throttle-debounce";
...
class ae extends at {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = t.slice() : this.rawArray = ae.parseXY(t);
  }
  ...
  static fromESRI(e, t) {
    return new ae(t, [e.x, e.y], T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new _s({
      x: this.x,
  ...
  static fromGeoJSON(e, t) {
    return new ae(t, e.coordinates, T.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class we extends at {
  ...
  getAt(e) {
    return new ae(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
...
class H extends at {
  ...
  rawMax;
  constructor(e, t, i, r) {
    super(e, t.sr || r), this.rawMin = ae.parseXY(t), this.rawMax = ae.parseXY(i);
  }
...
class zs {
  ...
  esriMapClickToRamp(e, t) {
    return {
      mapPoint: ae.fromESRI(e.mapPoint, t),
      screenX: e.x,
      screenY: e.y,
      button: e.button,
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Je.fromESRI(i, t) : Te.fromESRI(i, t);
      }
      case "polygon":
...
class St {
  ...
  clone() {
    return new St(this.id, this._defaultExtent, this._fullExtent, this._maximumExtent);
  }
}
class X {
  realPromise;
...
const Ft = W("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ft(), t = Ie("iApi"), i = D(() => e.maptipPoint), r = D(() => e.maptipInstance), a = D(() => e.content), o = Se([]), l = f(!1);
    o.push(
      Ct(i, () => {
        if (i.value) {
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
  ...
  function O() {
    ...
    for (let _e = n.value.length - 1; _e >= 0; _e--) {
      const lt = n.value[_e];
      let Fe = lt.width || Q;
      if (r.value ? Fe = E : Fe += Ae, lt.id === "grid" && (Fe = Math.max(Math.min(Fe, E), je)), (E >= Fe && !r.value || L.length === 0) && (E -= Fe, L.unshift(lt)), lt.id === "grid" && E < je)
        break;
    }
    ...
    !L.includes(s.value) && !r.value) {
      ...
      for (let mi = 0; mi < L.length - 1 && E < (s.value.width || Q) + Ae; mi++)
        _e = L.shift(), E += _e.width || Q;
      E >= (s.value.width || Q) ? L.unshift(s.value) : e.value || (_e = L.shift(), L.unshift(s.value));
      const lt = n.value.indexOf(s.value), Fe = n.value.indexOf(_e), Bt = n.value.slice();
      Fe > -1 && (Bt.splice(lt, 1), Bt.splice(Fe, 0, s.value)), n.value = Bt;
    }
    i.value = E, u.value = L;
  }
  function F(E) {
  ...
  setup(s) {
    ...
    const e = st(), t = Ie("iApi"), i = f(), r = D(() => e.opacity), a = D(() => e.mobileView);
    rt(() => {
    ...
    return (u, p) => (b(), te(Fi, {
      ...
      default: ue(() => [
        (b(!0), A(it, null, wt(o(I(t).screenSize), (d) => (b(), te(Ki, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  setup(s) {
    const e = f(!1), t = f(null), i = Se([]), r = f(), a = f(), o = f(), l = s;
    i.push(
      Ct(e, () => {
        t.value.update();
      })
  ...
  setup(s) {
    ...
    return (a, o) => {
      const l = oe("panel-screen"), n = G("tippy");
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
  ...
  setup(s) {
    const e = Ne(), { t } = ie(), i = s, r = f(!1), a = Se({
      [xe.WARNING]: "⚠",
      [xe.INFO]: "ℹ️",
      [xe.ERROR]: "❌"
    }), o = (n) => {
    ...
    return (n, c) => {
      ...
      return U((b(), A("li", {
        ...
        s.notification.messageList && r.value ? (b(), A("div", gr, [
          (b(!0), A(it, null, wt(s.notification.messageList, (p, d) => (b(), A("p", {
    ...
    return (l, n) => {
      ...
      return b(), A("div", null, [
        o.value.length > 0 ? U((b(), A("ul", {
          ...
          (b(!0), A(it, null, wt(o.value, (d, g) => (b(), A(it, {
            key: d.message + g
          }, [
            g > 0 ? (b(), A("div", wr)) : z("", !0),
            U(fe(vr, {
  ...
  setup(s) {
    const { t: e } = ie(), t = Ie("iApi"), i = () => {
      t.reload();
    }, r = D(() => `${Et.major}.${Et.minor}.${Et.patch}`), a = D(() => Et.hash.slice(0, 9)), o = D(() => {
      const l = new Date(Et.timestamp);
      if (isNaN(l.getTime()))
    ...
    return (l, n) => {
      const c = oe("close"), u = oe("dropdown-menu"), p = G("tippy"), d = G("focus-item");
      return U((b(), te(u, {
...
}), zr = /* @__PURE__ */ qe(Br, [["__scopeId", "data-v-24f3a9dc"]]), qr = "S", jr = "__HELP__", Qi = W("keyboardnav", () => {
  ...
  __name: "map-caption",
  setup(s) {
    const e = Ye(), t = Qi(), i = be(), { t: r } = ie(), a = Ie("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: y } = hs(t), w = D(() => {
      ...
      if (g.value === "awaitNamespace") {
        ...
        E && E.keys?.length && (q = `[${E.keys.map((Q) => {
          const Ae = `keyboardnav.key.${J}.${Q.key}`, je = r(Ae), _e = je === Ae ? Q.key : je;
          return `${Q.key} - ${_e}`;
        }).join(", ")}]`);
      }
      return {
    ...
    return (F, _) => {
      const M = oe("dropdown-menu"), P = G("truncate"), q = G("tippy");
      return b(), A("div", Hr, [
        fe(zr, {
        ...
        w.value ? (b(), A("span", Kr, [
          m("span", Zr, [
            ...
            m("span", Xr, B(w.value.keys), 1),
            w.value.cursor ? (b(), A("span", Qr, "_")) : z("", !0),
  ...
  setup(s) {
    const e = Ne(), t = Ie("iApi"), { t: i } = ie(), r = D(() => e.notificationNumber);
    return (a, o) => {
      const l = G("tippy");
      return U((b(), A("button", {
        type: "button",
  ...
  setup(s) {
    const e = Ie("iApi"), { t } = ie(), i = f(!1), r = f(["app", "lists", "map", "keyboardNav"]), a = f([]), o = f(null), l = f(null);
    rt(() => {
      a.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), A("div", {
        ...
        m("div", {
          ...
          (b(!0), A(it, null, wt(r.value, (d) => (b(), A("p", {
...
}), pt = W("instance", () => ({ started: f(!1) })), va = { class: "h-full relative" }, ba = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, wa = { class: "absolute top-8 w-full flex justify-center" }, Aa = {
  key: 1,
  class: "w-full h-full"
}, Ea = /* @__PURE__ */ N({
  __name: "shell",
  setup(s) {
    const e = Ie("iApi"), t = pt(), i = Ee(), r = st(), { t: a } = ie(), o = D(() => i.items.appbar), l = () => {
    ...
    return (c, u) => (b(), A("div", va, [
      m("div", ba, [
        ...
        o.value ? z("", !0) : (b(), te(fa, { key: 0 })),
        fe(ua, { class: "z-30" })
      ]),
      I(t).started ? (b(), te(ir, { key: 0 })) : (b(), A("div", Aa, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (b(!0), A(it, null, wt(n(), (p) => (b(), te(As, {
...
const La = /* @__PURE__ */ qe(Sa, [["render", Ta]]), Oe = "focus-list", Xe = "focus-item", Ra = "focus-icon", $a = "focus-container", yt = `[${Oe}],[${$a}]`, _t = "truncate-text", Tt = "show-truncate", ht = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Oe}],[${Ra}],[tabIndex]`, Ca = {
  mounted(s, e) {
...
function es(s) {
  s.querySelectorAll(Zt).forEach((t) => {
    if (t.closest(yt) === s || t.closest(yt) === t && t.parentElement.closest(yt) === s)
      if (t.closest(`[${Oe}],.${ht}`).classList.contains(ht))
...
class Oa {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Zt).forEach((r) => {
      (e === -1 || r.closest(yt) === this.element || r.closest(yt) === r && r.parentElement.closest(yt) === this.element || r.closest(`[${Oe}],.${ht}`).classList.contains(ht)) && r.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(ht), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Xe) === Tt && e.querySelector(`[${_t}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ht), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Xe) === Tt && e.querySelector(`[${_t}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      this.element.querySelectorAll(`[${Xe}]`),
  ...
  onClick(e) {
    ...
    this.highlightedItem = t.closest(`[${Xe}]`) || t.closest(`[${Oe}]`) || this.highlightedItem, t.hasAttribute(`${Xe}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Xe) === Tt && this.highlightedItem.querySelector(`[${_t}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), es(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Xe) === Tt && this.highlightedItem.querySelector(`[${_t}]`)?._tippy?.hide());
  }
  /**
...
const za = ["content"], qa = {
  ...
  setup(s, { expose: e }) {
    const { t } = ie(), i = st(), r = Nt(), a = Ie("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
    ...
    return rt(() => {
      ...
      const Y = oe("back"), R = oe("panel-options-menu"), V = oe("left"), O = oe("right"), F = oe("pin"), _ = oe("expand"), M = oe("minimize"), P = oe("close"), q = G("truncate"), J = G("focus-item"), E = G("tippy");
      return U((b(), A("div", {
...
}), Za = { class: "relative" }, Xa = ["content", "aria-label"], Qa = ["transform"], eo = /* @__PURE__ */ N({
  __name: "pin",
  props: {
    active: Boolean
  },
  ...
  setup(s) {
    const e = Ie("iApi"), t = s, i = () => e.event.emit(x.APPBAR_BUTTON_CLICK, t.buttonId);
    return (r, a) => {
...
var rs = /* @__PURE__ */ ((s) => (s.Visibility = "visibilityButton", s.Expand = "expandButton", s))(rs || {}), Xt = /* @__PURE__ */ ((s) => (s.Item = "item", s.Placeholder = "placeholder", s.Error = "error", s))(Xt || {});
class as extends se {
  _uid;
  _name;
  _type;
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = tt.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new X(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof He) || this._lastVisible.layerControlAvailable(ee.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (r) => !(r instanceof He) || r.layerControlAvailable(ee.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof He && !this.layerControlAvailable(ee.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
...
class un {
   ...
   */
  initialize(e, t, i) {
    const r = be(this.$vApp.$pinia), a = st(this.$vApp.$pinia), o = Ft(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = pt(this.$vApp.$pinia), r = Ne(this.$vApp.$pinia), a = be(this.$vApp.$pinia), o = Ee(this.$vApp.$pinia), l = Me(this.$vApp.$pinia), n = Jt(this.$vApp.$pinia), c = !!e;
...
function pn(s, e) {
  ...
  r.directive("focus-container", Na), r.directive("focus-list", Ca), r.directive("focus-item", ka), r.directive("truncate", Ua), r.component("panel-screen", Ka), r.component("pin", eo), r.component("close", so), r.component("back", oo), r.component("expand", po), r.component("panel-options-menu", xo), r.component("dropdown-menu", si), r.component("minimize", mo), r.component("right", vo), r.component("left", Ao), r.component("fullscreen-nav-button", _o), r.component("geolocator-nav-button", To), r.component("home-nav-button", Lo), r.component("mapnav-button", Co), r.component("appbar-button", Po), r.component("transition", Ni), r.component("transition-group", Fi), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || tt.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class dn extends se {
   ...
   */
  getExtentSet() {
    return this._rampExtentSet ? this._rampExtentSet : (this.noMapErr(), St.fromConfig({
...
class mn extends dn {
  ...
  async createMapView(e) {
    ...
    this._rampExtentSet = St.fromConfig(o), this._rampSR = this._rampExtentSet.sr.clone();
  ...
  async setBasemap(e) {
    ...
    if (a) {
      ...
      this._viewPromise = new X(), this.created = !1, this.$iApi.event.emit(x.MAP_REFRESH_START), this.destroyMapView(), this.createMapView(i), await this.viewPromise.then(() => {
  ...
  screenPointToMapPoint(e) {
    return this.esriView ? ae.fromESRI(
      this.esriView.toMap({
        x: e.screenX,
        y: e.screenY
      }),
      "mappoint"
    ) : (this.noMapErr(), new ae("i_am_error", [0, 0], void 0, !0));
  }
  /**
...
class os extends ci {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = re.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = Z.NEW, this.initiationState = j.NEW, this.drawState = ve.NOT_LOADED, this.loadDefProm = new X(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new Mt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(j.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new X(), this.loadPromDone = !1, this.updateLayerState(Z.NEW), this.updateDrawState(ve.NOT_LOADED), this.updateInitiationState(j.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(r).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new X()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((a) => a.onLoad()), this.updateLayerState(Z.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== Z.ERROR && (this.initiationState === j.INITIATING && this.updateInitiationState(j.NEW), this.loadPromDone && (this.loadDefProm = new X()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      xe.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
...
class ot extends os {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new ji(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? H.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new X(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
...
class nt extends ui {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = le.ESRI_FEATURE, this.layerFormat = ye.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== re.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = re.HYBRID;
  }
  async reload() {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === re.HYBRID || this.identifyMode === re.SYMBOLIC) && (r = a.then(async () => {
      ...
      o.forEach((n) => {
        i.items.push(gt.makeRawItem(Qe.ESRI, n.attributes));
      }), l.forEach((n) => {
...
class Dn extends ui {
  constructor(e, t) {
    super(e, t), this.dataFormat = le.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = ye.FEATURE, e.identifyMode && e.identifyMode !== re.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = re.HYBRID;
  }
  async onInitiate() {
...
class Gn extends ot {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = ye.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = re.GEOMETRIC;
  }
  async onInitiate() {
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === $.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((r) => {
      ...
      return r.geomType !== $.POLYGON && i ? o.filterGeometry = i : o.filterGeometry = e.geometry, o.filterSql = r.getCombinedSqlFilter(), o.sourceSR = r.sourceSR, r.queryOIDs(o).then((n) => {
        n.forEach((c) => {
          l.items.push(gt.makeOidItem(c, r));
...
class jn extends pi {
  constructor(e, t) {
    super(e, t), this.layerType = S.VECTORTILE, this.layerFormat = ye.VECTORTILE, this.supportsIdentify = !0, this.identifyMode = re.GEOMETRIC;
  }
  async onInitiate() {
  ...
  runIdentify(e) {
    ...
    return this.esriView.view.hitTest(e.coord, { include: this.esriLayer }).then((r) => {
      r.results.filter((a) => a.type === "graphic").forEach((a) => {
        i.items.push(gt.makeRawItem(Qe.HTML, this.toHTML(a.graphic.attributes)));
      }), i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
    }), [i];
  ...
  toHTML(e) {
    return `<div class="p-8">${Object.entries(e).map(([i, r]) => `<div class="p-5 pl-3 flex justify-end flex-wrap even:bg-gray-300"><span class="inline font-bold">${i}</span><span class="flex-auto"></span><span class="inline">${r}</span></div>`).join("")}</div>`;
  }
}
class Hn extends ot {
  sublayerNames;
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = ye.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = le.OGC_RASTER, this.identifyMode = re.GEOMETRIC;
  }
  async onInitiate() {
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((r) => {
      if (r) {
        let a = !0, o;
        typeof r != "string" ? o = Qe.JSON : r.indexOf("Search returned no results") === -1 && r !== "" ? o = Qe.TEXT : (a = !1, o = Qe.UNKNOWN), a && i.items.push(gt.makeRawItem(o, r));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
...
class sl extends se {
  ...
  async symbolToSvg(e) {
    ...
    const a = ct(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: h, path: y }) {
...
class al extends se {
   ...
   */
  constructor(e) {
    super(e), this.geom = tt.geom, this.proj = tt.proj, this.shared = tt.sharedUtils, this.map = new mn(e), this.layer = new Rn(e), this.attributes = new Zn(e), this.query = new rl(e), this.symbology = new sl(e), Array.isArray(At.request.interceptors) || (At.request.interceptors = []), At.request.interceptors.push({
      before: (t) => {
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CodbUyV9.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BJnb9y6l.js"), "../fixtures/basemap/index.ts": () => import("./index-ofKV43iq.js"), "../fixtures/crosshairs/index.ts": () => import("./index-Bb1FauKI.js"), "../fixtures/details/index.ts": () => import("./index-DfFUmv1o.js"), "../fixtures/draw/index.ts": () => import("./index-DjXdA2Aw.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CM__gtNp.js"), "../fixtures/export-legend/index.ts": () => import("./index-BjI6S8U7.js"), "../fixtures/export-map/index.ts": () => import("./index-CFkq3W2B.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-LY6jISFZ.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Dq0ova9j.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-B_aQzLiE.js"), "../fixtures/export-title/index.ts": () => import("./index-BVJFfr_p.js"), "../fixtures/export/index.ts": () => import("./index-DbvWdNUn.js"), "../fixtures/extentguard/index.ts": () => import("./index-DxruAh0X.js"), "../fixtures/gazebo/index.ts": () => import("./index-DJVgFlng.js"), "../fixtures/geosearch/index.ts": () => import("./index-xv7u_ki6.js"), "../fixtures/grid/index.ts": () => import("./index-N83PA9pA.js"), "../fixtures/help/index.ts": () => import("./index-DxdrWtqs.js"), "../fixtures/hilight/index.ts": () => import("./index-_t5A5rPS.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-DpDf4VZP.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-D91aqboY.js"), "../fixtures/legend/index.ts": () => import("./index-DKeqo2Lz.js"), "../fixtures/mapnav/index.ts": () => import("./index-BW7QGUps.js"), "../fixtures/metadata/index.ts": () => import("./index-De4PlLk_.js"), "../fixtures/northarrow/index.ts": () => import("./index-BYt5rF_T.js"), "../fixtures/overviewmap/index.ts": () => import("./index-D1wIbe3X.js"), "../fixtures/panguard/index.ts": () => import("./index-BDHgrV2m.js"), "../fixtures/scrollguard/index.ts": () => import("./index-WhsoQTky.js"), "../fixtures/settings/index.ts": () => import("./index-C9rbF85S.js"), "../fixtures/snowman/index.ts": () => import("./index-bOXg6I-K.js"), "../fixtures/swipe/index.ts": () => import("./index-BQZSCGTy.js"), "../fixtures/wizard/index.ts": () => import("./index-CMEtOQc-.js") });
class nl extends se {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DhNbHHXu.js"), "../fixtures/basemap/screen.vue": () => import("./screen-D8eN3gR_.js"), "../fixtures/export/screen.vue": () => import("./screen-C9dgd_0a.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-C_CQ4AYC.js"), "../fixtures/grid/screen.vue": () => import("./screen-Cj3sLAQu.js"), "../fixtures/help/screen.vue": () => import("./screen-BFWEeCFE.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BwKu_oxD.js"), "../fixtures/legend/screen.vue": () => import("./screen-CZfHr-Xu.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DyTExEz2.js"), "../fixtures/settings/screen.vue": () => import("./screen-BPDS2Y7D.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BG_gZN6o.js") });
class $t extends se {
  /**
   * ID of this panel.
   *
...
function Qt(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = vt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
  ), e.controls.push("expandButton")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledControls = vt(s.disabledControls, t), s.disabledControls.includes("visibility") && e.disabledControls.push("visibilityButton"), (s.disabledControls.length !== 1 || s.disabledControls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
...
function Mi(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.layerControls = vt(s.controls, t), e.layerControls.push("symbology")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledLayerControls = vt(s.disabledControls, t)), s.controlledIds && (console.warn(
...
function Wt(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = vt(s.controls, t), e.controls.push("symbology")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledControls = vt(s.disabledControls, t)), s.state && (e.state = {
...
var dt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Fri Dec 12 11:08:23 2025 -0600", hash: "28f21597a56b63450a65f5f21d6ab3885f5aeb1d" };
console.info(
...
const lc = (s, e, t) => new un(s, e, t), tt = new Ws();
export {
  Ge as $,
  zr as A,
  nn as B,
