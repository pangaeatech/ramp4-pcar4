...
import { _ as H, d as L, F as X, G as ee } from "./main-Bk3UQUEB.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-v17jMsXU.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-nkPyuWCw.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Bmyt-IaL.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CZNS0ve3.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D9TMwHQ3.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CV2zjJcH.js")))
      }), s;
    }), n = (s) => {
