import{o as m}from"./BufferObject-B95R0UG4.js";import{m as p,s as u}from"./FramebufferObject-ZC4cZzhN.js";import{s as c}from"./ProgramTemplate-B2GvnihN.js";import{e as l,a as d}from"./ProgramTemplate-B2GvnihN.js";import"./main-CAvSCzl4.js";import{A as $}from"./Texture-8latdqtJ.js";import{h}from"./VertexArrayObject-DT8zLVmp.js";class b{constructor(e){this._rctx=e,this._store=new Map}dispose(){this._store.forEach(e=>e.dispose()),this._store.clear()}acquire(e,t,r,s){const i=e+t+JSON.stringify(Array.from(r.entries())),o=this._store.get(i);if(o!=null)return o.ref(),o;const n=new c(this._rctx,e,t,r,s);return n.ref(),this._store.set(i,n),n}get test(){}}function y(a){const{options:e,value:t}=a;return typeof e[t]=="number"}function _(a){let e="";for(const t in a){const r=a[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
