...
import { _ as H, d as L, F as K, G as X } from "./main-BHEBGJ50.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-C28Ol5HZ.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Dj6g8QeJ.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DuzNY-GN.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DrP4YI9v.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CqvsVE-9.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DZdAGnO0.js")))
      }), s;
    }), n = (s) => {
