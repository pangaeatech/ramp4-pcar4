...
import { _ as H, d as L, F as K, G as X } from "./main-B_DiLIgl.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CV0oFLyS.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DW_7AYim.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Cg1jzL35.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DHDUTct5.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-iV2-_tuD.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-6meiz_fR.js")))
      }), s;
    }), n = (s) => {
