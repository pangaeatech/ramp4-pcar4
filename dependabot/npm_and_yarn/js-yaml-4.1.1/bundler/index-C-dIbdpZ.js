...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-B_DiLIgl.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DHDUTct5.js"), "./icons/edit-icon.vue": () => import("./edit-icon-6meiz_fR.js"), "./icons/point-icon.vue": () => import("./point-icon-CV0oFLyS.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-Cg1jzL35.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DW_7AYim.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-iV2-_tuD.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
