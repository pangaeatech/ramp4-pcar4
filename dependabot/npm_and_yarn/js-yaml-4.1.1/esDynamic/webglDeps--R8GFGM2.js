import{E as m,o as p}from"./VertexArrayObject-DLGxiEsa.js";import{R as l,s as u}from"./FramebufferObject-ChqP057q.js";import{a as c}from"./ProgramTemplate-DHrMW6Dz.js";import{e as d,b as $}from"./ProgramTemplate-DHrMW6Dz.js";import"./main-JmTRuo2v.js";import{t as b}from"./NestedMap-DL9KstBd.js";import{S as h}from"./Texture-c_fMIapx.js";class x{constructor(e){this._rctx=e,this._store=new b}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,r,i){const s=this._store.get(e,t);if(s!=null)return s.ref(),s;const o=new c(this._rctx,e,t,r,i);return o.ref(),this._store.set(e,t,o),o}get test(){}}function _(n){const{options:e,value:t}=n;return typeof e[t]=="number"}function g(n){let e="";for(const t in n){const r=n[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
